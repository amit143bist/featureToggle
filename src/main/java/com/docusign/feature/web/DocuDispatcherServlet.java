package com.docusign.feature.web;
...
/**
 * Servlet implementation class DocuDispatcherServlet
 */
public class DocuDispatcherServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/** Logger for this class. */
	public static final Logger LOGGER = LoggerFactory.getLogger(DocuDispatcherServlet.class);

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DocuDispatcherServlet() {
		super();
	...
	private void initializeTemplateEngine() {
		...
		templateResolver.setPrefix("thymleafviews/view-");
	...
	public FF4j getFf4j() {
		if (ff4j == null) {
			throw new IllegalStateException(
					"Console Servlet has not been initialized, please set 'load-at-startup' to 1");
		}
		return ff4j;
	}
